...
func Cache_listbyserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/caches%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
...
func CreateCache_listbyserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_caches",
		mcp.WithDescription("Lists a collection of all external Caches in the specified service instance."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Cache_listbyserviceHandler(cfg),
	}
}
