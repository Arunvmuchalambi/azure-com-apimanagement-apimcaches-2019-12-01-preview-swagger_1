...
func Cache_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCache_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_caches_cacheId",
		mcp.WithDescription("Deletes specific Cache."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Cache_deleteHandler(cfg),
	}
}
